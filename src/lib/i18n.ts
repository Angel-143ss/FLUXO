export const translations = {
  es: {
    ...
    installAppDesc: 'Instala FLUXO en tu dispositivo para acceso rápido y sin conexión.',
  ...
  en: {
    ...
    installAppDesc: 'Install FLUXO on your device for fast, offline-ready access.',
    version: 'App Version',
    close: 'Close',
    ideas: 'Ideas',
    exercises: 'Exercises',
